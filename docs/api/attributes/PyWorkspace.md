# PyWorkspace Attributes

公式 Help の Attributes ページを原文寄りに整理したもの。

| 項目 | 内容 |
|------|------|
| 一次情報 | `docs/API Documentation/Attributes/PyWorkspace Attributes/` |
...
- **Type:** `flame.PyReelGroup`
- **Description:** The Workspace current Reel Group (PyReelGroup).
- **Value range:** None
