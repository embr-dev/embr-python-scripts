# PyDesktop Attributes

公式 Help の Attributes ページを原文寄りに整理したもの。

| 項目 | 内容 |
|------|------|
| 一次情報 | `docs/API Documentation/Attributes/PyDesktop Attributes/` |
...
- **Type:** `flame.PyLibrary`
- **Description:** The Save destination attribute of the Desktop; this attribute is a PyLibrary or PyFolder object.
- **Value range:** None

### `current_batch_group`

- **Type:** `flame.PyBatch`
- **Description:** The Batch Group currently open and displayed in the Batch UI.
- **Value range:** None
